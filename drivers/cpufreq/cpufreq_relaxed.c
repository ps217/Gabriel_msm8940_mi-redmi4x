...
static struct cpufreq_governor cpufreq_gov_relaxed = {
	.name			= "relaxed",
		...
		void *data)
{
	...
	/* policy isn't governed by relaxed governor */
	if (policy->governor != &cpufreq_gov_relaxed)
		return 0;
